...
const faqData = [
    {
        ...
        answer: `If you're not satisfied with your purchase, we accept returns within 30 days of delivery. To initiate a return, please email us at example@gmail.com
    ...
    },
    {
        ...
        answer: `You can contact our customer support team by emailing us at example@gmail.com
