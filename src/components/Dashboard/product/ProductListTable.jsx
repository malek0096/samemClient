                  ...
                  return (
                    <TableRow hover key={product._id}   >
                      <TableCell>
                        ...
                        >
                          {product?.designImage && product?.designImage?.length > 0 ? (
                            <Box>
                              <img
                                alt="Product"
                                src={product.designImage[0].url}
                                style={{
                                  height: 100,
                                  width: 100,
                                  objectFit: 'cover',
                      ...
                      <TableCell>{product?.category[0]?.name || "T-SHIRTS"}</TableCell>
                      ...
                      <TableCell align="right">
                        ...
                        <IconButton onClick={() => handleDelete(user.userId, product?._id)}>
